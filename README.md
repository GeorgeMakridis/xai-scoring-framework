...
- Processed data in `data/{type}/` folders: `dataset_metadata.csv`, `ai_model_performance.csv`, `xai_quantitative_metrics.csv`, `xai_qualitative_ratings.csv` (see `data/DATA_STRUCTURE.md`)
